...
## name: plot_sub3_final_vs_baseline.r
## date: 02/22/2018
...
## breast
path1="../sub3/prediction/breast/proteome/"
path2="../sub3/prediction/breast/final/"
ymax=3
...
## ova
path1="../sub3/prediction/ova/proteome/"
path2="../sub3/prediction/ova/final/"
ymax=2
...
pdf(file="../figure/sub3_final_vs_baseline.pdf",width=8,height=6)
