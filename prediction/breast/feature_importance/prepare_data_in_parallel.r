...
## this is adapted from CPTAC_final/sub3/prediction/m201
## I didn't rerun it
...
feature=as.matrix(read.delim(paste0(path1,"raw_breast_rna.txt.avg_imputation.subset1.0"),check.names=F,row.names=1))
train=as.matrix(read.delim(paste0(path0,"breast_proteome.txt"),check.names=F,row.names=1))
