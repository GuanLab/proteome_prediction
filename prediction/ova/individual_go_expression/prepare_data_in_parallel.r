...
feature=as.matrix(read.delim(paste0(path1,"raw_ova_rna.txt.avg_imputation.go_expression"),check.names=F,row.names=1))
train=as.matrix(read.delim(paste0(path2,"train_ova_proteome_",i,".txt"),check.names=F,row.names=1))
